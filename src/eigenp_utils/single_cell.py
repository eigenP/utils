...
def find_correlated_features(
    ...
    if "wasserstein" in metrics:
        ...
        # matth: The 1D Wasserstein distance between equal-sized empirical distributions
        # has an exact closed-form solution: the L1 distance of their order statistics.
        # By pre-sorting the target distribution, we reduce the inner loop complexity
        # and eliminate the overhead of scipy's numerical integration entirely.
