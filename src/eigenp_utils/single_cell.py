...
def find_correlated_features(
    ...
    if "wasserstein" in metrics:
        ...
        # matth: The 1D Wasserstein-1 distance between two empirical distributions
        # of equal size simplifies exactly to the L1 distance of their order statistics.
        # By pre-sorting the target distribution and calculating the mean absolute difference
        # of sorted arrays, we bypass the numerical integration overhead of
        # scipy.stats.wasserstein_distance and avoid redundantly sorting the target array.
