            ...
            if method == 'mahalanobis':
                ...
                if valid_row_mask.any():
                    ...
                    if n_samples > n_features + 1:
                        a = n_features / 2.0
                        b = (n_samples - n_features - 1) / 2.0
                        beta_thresh = stats.beta.ppf(threshold, a, b)
                        mahalanobis_thresh = ((n_samples - 1)**2 / n_samples) * beta_thresh
                    else:
                        mahalanobis_thresh = stats.chi2.ppf(threshold, df=n_features)

                    valid_keep = D_squared <= mahalanobis_thresh
