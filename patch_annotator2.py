...
replacement = """class TNIAAnnotatorWidget(TNIASliceWidget):
    ...
    def _init_observers(self):
        ...
        # Also re-render if annotation_mode changes (so UI cursor updates, but that's in JS mostly)
    ...
    def _handle_click(self, change):
        ...
        # But JS might be passing pre-inverted y_frac or plain y_frac?
        # Let's adjust properly inside this method later if needed.
        # Actually, let's just delegate the coordinate math cleanly.
