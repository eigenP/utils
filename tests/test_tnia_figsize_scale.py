def test_tnia_figsize_scale():
    ...
    widget1 = show_xyz_max_slice_interactive(im, figsize_scale=1)
    widget2 = show_xyz_max_slice_interactive(im, figsize_scale=2)
    widget3 = show_xyz_max_slice_interactive(im, figsize_scale=10)
